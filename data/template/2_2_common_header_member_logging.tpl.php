...
0
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/header_common.htm', 1397040799, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/new', 'common/header_member_logging')
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/header_qmenu.htm', 1397040799, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/new', 'common/header_member_logging')
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/pubsearchform.htm', 1397040799, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/new', 'common/header_member_logging')
;?>
