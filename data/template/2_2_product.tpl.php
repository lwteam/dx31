<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('product');
0
|| checktplrefresh('./develop/manage/template/product.htm', './template/new/common/header.htm', 1396854047, '2', './data/template/2_2_product.tpl.php', './develop/manage/template', 'product')
|| checktplrefresh('./develop/manage/template/product.htm', './template/new/common/footer.htm', 1396854047, '2', './data/template/2_2_product.tpl.php', './develop/manage/template', 'product')
|| checktplrefresh('./develop/manage/template/product.htm', './template/new/common/header_common.htm', 1396854047, '2', './data/template/2_2_product.tpl.php', './develop/manage/template', 'product')
|| checktplrefresh('./develop/manage/template/product.htm', './template/new/common/header_qmenu.htm', 1396854047, '2', './data/template/2_2_product.tpl.php', './develop/manage/template', 'product')
|| checktplrefresh('./develop/manage/template/product.htm', './template/new/common/pubsearchform.htm', 1396854047, '2', './data/template/2_2_product.tpl.php', './develop/manage/template', 'product')
;?>
...
<script src="static/js/jquery.bbs.js" type="text/javascript"></script>
</head>
...
<div id="wp" class="wp"><?php include template('header',0, './develop/manage/template');?><div class="mgcont">

<div class="mgtit">
<?php echo $manageitem_array[$action];?>
</div>
<form method="post" autocomplete="off" action="manage.php?action=<?php echo $action;?>&amp;operation=update" enctype="multipart/form-data">
<input type="hidden" name="formhash" id="formhash" value="<?php echo FORMHASH;?>" />
<?php if($id) { ?>
<input type="hidden" name="id" value="<?php echo $id;?>" />
<?php } ?>

<table class="distproduct" cellpadding="2" cellspacing="2" border="0" width="100%">
<tr  class="tit">
<td  colspan="2">分发权限</td>
</tr>
<tr>
<td  class="tit">稳定版版本</td>
<td  ><input type="text" name="product[stable]" value="<?php echo $product['stable'];?>" /></td>
</tr>
<tr>
<td  class="tit">稳定版更新时间</td>
<td  ><input type="text" name="product[stabledateline]" value="<?php echo $product['stabledateline'];?>" /></td>
</tr>
<tr>
<td  class="tit">开发版版本</td>
<td  ><input type="text" name="product[develop]" value="<?php echo $product['develop'];?>" /></td>
</tr>
<tr>
<td  class="tit">开发版更新时间</td>
<td  ><input type="text" name="product[developdateline]" value="<?php echo $product['developdateline'];?>" /></td>
</tr>
<tr>
<td ></td>
<td ><button type="submit" id="postsubmit" class="whitec darkga mfont" value="true" name="topicsubmit"><span>更新</span></button>
</td>
</tr>
</table>
</form>
