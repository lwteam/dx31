...
0
|| checktplrefresh('./template/new/forum/post.htm', './template/new/forum/post_editor_extra.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/default/forum/post_editor_body.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/default/forum/post_editor_attribute.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/default/forum/seccheck_post.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/new/common/editor_menu.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/default/forum/editor_menu_forum.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/new/common/upload.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/new/common/editor.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/new/common/seccheck.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
|| checktplrefresh('./template/new/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1396962364, '2', './data/template/2_2_forum_post.tpl.php', './template/new', 'forum/post')
...
<?php } ?>
onsubmit="return <?php if(BUGLIST =='post') { ?>jQuery.bugsubmit(this)<?php } else { ?>validate(this)<?php } ?>">
...
<style>
._dis {display:none}
.buglist-cselect select{width:160px;height:100px;}
</style>
<div class="exfm cl _bug">
<div class="sinf sppoll z">
<input type="hidden" name="classid"  id="classid" value="<?php echo $bthread['classid'];?>">
<input type="hidden" name="btid"  id="btid" value="<?php echo $bthread['tid'];?>">
反馈问题选项
<p>
分类:
<span>
<?php if($bthread['classid']) { $bfid = substr($bthread[classid],0,1);?><?php echo $_Data['buglist'][$bfid];?>   &gt;   <?php echo $_Data['buglist'][$bthread['classid']];?>
<?php } ?>
</span>
</p>
<div class="buglist-cselect">

<select size="10"  class="_bugclass"><?php if(is_array($_Data['buglist'])) foreach($_Data['buglist'] as $key => $value) { if(strlen($key) == 1) { ?><option value="<?php echo $key;?>" <?php if(($key == substr($bthread['classid'],0,1))) { ?> selected<?php } ?>><?php echo $value;?></option><?php } } ?>
</select><?php $topid = 0;?><?php if(is_array($_Data['buglist'])) foreach($_Data['buglist'] as $key => $value) { if(strlen($key) == 1) { if($topid != $key) { if($topid >0) { ?></select><?php } ?>
<select size="10" class="_bugsclass _bugsclass<?php echo $key;?><?php if(($key != substr($bthread['classid'],0,1))) { ?> _dis<?php } ?>">
<?php } } else { ?>
<option value="<?php echo $key;?>" <?php if($bthread['classid'] == $key) { ?> selected<?php } ?>><?php echo $value;?></option>
