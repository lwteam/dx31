...
0
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/header_common.htm', 1396851666, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/new', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/header_qmenu.htm', 1396851666, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/new', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/pubsearchform.htm', 1396851666, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/new', 'common/header_forum_forumdisplay')
;?>
