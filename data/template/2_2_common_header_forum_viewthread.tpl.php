...
0
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/header_common.htm', 1396851631, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/new', 'common/header_forum_viewthread')
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/header_qmenu.htm', 1396851631, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/new', 'common/header_forum_viewthread')
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/pubsearchform.htm', 1396851631, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/new', 'common/header_forum_viewthread')
;?>
