...
0
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/header_common.htm', 1396962364, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/new', 'common/header_forum_post')
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/header_qmenu.htm', 1396962364, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/new', 'common/header_forum_post')
|| checktplrefresh('./template/new/common/header.htm', './template/new/common/pubsearchform.htm', 1396962364, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/new', 'common/header_forum_post')
;?>
