...
$lang = array (
  ...
  'connect_fill_profile_to_post' => '您需要 <a href="member.php?mod=connect">完善帐号信息</a> 或 <a href="member.php?mod=connect&ac=bind">绑定已有帐号</a> 后才可以发帖',
  ...
  'digest_posts' => '精华',
  'forum_group' => '版块/群组',
  'forum_nothreads' => '暂无玩家发表主题，赶紧抢头条！',
  'forum_thread' => '版块主题',
  'from' => '来自',
  'fromgroup' => '来自群组',
  ...
  'thread_rushreply' => '欢迎抢楼!',
  'thread_rushreply_check_back' => '返回抢楼帖',
  'thread_rushreply_end' => '截止楼层：',
  'thread_rushreply_floor' => '奖励楼层',
  'thread_rushreply_limit' => '{$rushresult[creditlimit_title]}大于{$rushresult[creditlimit]}可以抢楼',
  ...
  'attach_nopermission_connect_fill_profile' => '您需要 <a href="member.php?mod=connect" >完善帐号信息</a> 或 <a href="member.php?mod=connect&ac=bind">绑定已有帐号</a> 后才可以下载或查看',
